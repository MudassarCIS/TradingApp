...
class BingXApiService
{
    ...
    public function __construct()
    {
        ...
        $this->baseUrl = config('services.bingx.base_url', 'https://open-api.bingx.com');
        $this->apiKey = config('services.bingx.api_key');
        $this->secretKey = config('services.bingx.secret_key');
    }
    ...
    {
        try {
            $response = $this->makeRequest('GET', '/openApi/spot/v1/account', [
                'apiKey' => $apiKey,
                'secretKey' => $secretKey
            ]);
            ...
            Log::error('BingX API Error - Account Info: ' . $e->getMessage());
            return null;
        }
    }
    ...
    {
        try {
            $response = $this->makeRequest('GET', '/openApi/spot/v1/ticker/price', [
                'symbol' => $symbol
            ]);
            
            return (float) $response['price'];
        } catch (\Exception $e) {
            Log::error("BingX API Error - Price for {$symbol}: " . $e->getMessage());
            return null;
        }
    }
    ...
    {
        try {
            $response = $this->makeRequest('GET', '/openApi/spot/v1/ticker/24hr', [
                'symbol' => $symbol
            ]);
            
            return $response;
        } catch (\Exception $e) {
            Log::error("BingX API Error - 24hr Ticker for {$symbol}: " . $e->getMessage());
            return null;
        }
    }
    ...
    {
        try {
            $response = $this->makeRequest('GET', '/openApi/spot/v1/kline', [
                'symbol' => $symbol,
                'interval' => $interval,
                'limit' => $limit
            ]);
            ...
            Log::error("BingX API Error - Klines for {$symbol}: " . $e->getMessage());
            return null;
        }
    }
    ...
    {
        try {
            $response = $this->makeRequest('POST', '/openApi/spot/v1/trade/order', array_merge($orderData, [
                'apiKey' => $apiKey,
                'secretKey' => $secretKey
            ]));
            ...
            Log::error('BingX API Error - Place Order: ' . $e->getMessage());
            return null;
        }
    }
    ...
    {
        try {
            $response = $this->makeRequest('GET', '/openApi/spot/v1/trade/query', [
                'apiKey' => $apiKey,
                'secretKey' => $secretKey,
                'symbol' => $symbol,
                'orderId' => $orderId
            ...
            Log::error('BingX API Error - Order Status: ' . $e->getMessage());
            return null;
        }
    }
    ...
    {
        try {
            $response = $this->makeRequest('DELETE', '/openApi/spot/v1/trade/order', [
                'apiKey' => $apiKey,
                'secretKey' => $secretKey,
                'symbol' => $symbol,
                'orderId' => $orderId
            ...
            Log::error('BingX API Error - Cancel Order: ' . $e->getMessage());
            return null;
        }
    }
    ...
    public function getOpenOrders(string $apiKey, string $secretKey, string $symbol = null): ?array
    {
        try {
            ...
            $response = $this->makeRequest('GET', '/openApi/spot/v1/trade/openOrders', $params);
            
            return $response;
        } catch (\Exception $e) {
            Log::error('BingX API Error - Open Orders: ' . $e->getMessage());
            return null;
        }
    }
    ...
    {
        try {
            $response = $this->makeRequest('GET', '/openApi/spot/v1/common/symbols');
            
            return $response;
        } catch (\Exception $e) {
            Log::error('BingX API Error - Exchange Info: ' . $e->getMessage());
            return null;
        }
    }
    ...
    protected function makeRequest(string $method, string $endpoint, array $params = []): array
    {
        ...
        if (isset($params['apiKey'])) {
            $headers['X-BX-APIKEY'] = $params['apiKey'];
            unset($params['apiKey']);
        }
