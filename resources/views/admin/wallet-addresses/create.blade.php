...
@section('title', 'Create New Wallet Address')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create New Wallet Address</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.wallet-addresses.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('network') is-invalid @enderror" 
                                        ...
                                        <option value="TRC20" {{ old('network') == 'TRC20' ? 'selected' : '' }}>TRC20</option>
                                        <option value="ERC20" {{ old('network') == 'ERC20' ? 'selected' : '' }}>ERC20</option>
                                        <option value="BEP20" {{ old('network') == 'BEP20' ? 'selected' : '' }}>BEP20</option>
                                        <option value="BTC" {{ old('network') == 'BTC' ? 'selected' : '' }}>BTC</option>
                                        <option value="ETH" {{ old('network') == 'ETH' ? 'selected' : '' }}>ETH</option>
                                    </select>
                                    @error('network')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-group mb-3">
                            <label for="qr_code_image">QR Code Image (Optional)</label>
                            ...
                            <small class="form-text text-muted">If not provided, QR code will be auto-generated from wallet address.</small>
                            @error('qr_code_image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Wallet Address
                            </button>
                            <a href="{{ route('admin.wallet-addresses.index') }}" class="btn btn-secondary">
