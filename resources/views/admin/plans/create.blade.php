                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('investment_amount') is-invalid @enderror" 
                                           id="investment_amount" name="investment_amount" value="{{ old('investment_amount') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('joining_fee') is-invalid @enderror" 
                                           id="joining_fee" name="joining_fee" value="{{ old('joining_fee') }}" required>
                                    @error('joining_fee')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('fee_percentage') is-invalid @enderror" 
                                           id="fee_percentage" name="fee_percentage" value="{{ old('fee_percentage') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('bots_allowed') is-invalid @enderror" 
                                           id="bots_allowed" name="bots_allowed" value="{{ old('bots_allowed') }}" required>
                                    @error('bots_allowed')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('trades_per_day') is-invalid @enderror" 
                                           id="trades_per_day" name="trades_per_day" value="{{ old('trades_per_day') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('direct_bonus') is-invalid @enderror" 
                                           id="direct_bonus" name="direct_bonus" value="{{ old('direct_bonus') }}" required>
                                    @error('direct_bonus')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('referral_level_1') is-invalid @enderror" 
                                           id="referral_level_1" name="referral_level_1" value="{{ old('referral_level_1') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('referral_level_2') is-invalid @enderror" 
                                           id="referral_level_2" name="referral_level_2" value="{{ old('referral_level_2') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('referral_level_3') is-invalid @enderror" 
                                           id="referral_level_3" name="referral_level_3" value="{{ old('referral_level_3') }}" required>
