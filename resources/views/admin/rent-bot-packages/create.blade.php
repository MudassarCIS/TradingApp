    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.rent-bot-packages.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="package_name">Package Name <span class="text-muted">(e.g., PEX-1, PEX-2)</span></label>
                                    <input type="text" class="form-control @error('package_name') is-invalid @enderror" id="package_name" name="package_name" value="{{ old('package_name') }}" placeholder="e.g., PEX-1">
                                    @error('package_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('allowed_bots') is-invalid @enderror" id="allowed_bots" name="allowed_bots" value="{{ old('allowed_bots') }}" required>
                                    @error('allowed_bots')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('allowed_trades') is-invalid @enderror" id="allowed_trades" name="allowed_trades" value="{{ old('allowed_trades') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('validity') is-invalid @enderror" id="validity" name="validity" required>
                                        <option value="month" {{ old('validity') === 'month' ? 'selected' : '' }}>Per Month</option>
                                        <option value="year" {{ old('validity') === 'year' ? 'selected' : '' }}>Per Year</option>
                                    </select>
                                    @error('validity')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status" id="status_disabled" value="0" {{ old('status') == '0' ? 'checked' : '' }}>
